...
namespace IntugentWebApp.Pages.RnD_Users
{
    ...
    public class FormulationsModel : PageModel
    {
        ...
        //        public string gStudyType {  get; set; }
        //        public int gStudyTypeSelectedValue { get; set; }

        //        public string gChemist { get; set; }
        //        public int gChemistSelectedValue { get; set; }

        //        public string gOperator { get; set; }
        //        public int gOperatorSelectedValue { get; set; }
        //        public string gProductID { get; set; }
...
//            if (_objectsService.RNDHome.bDataRead == false) { ReadDataset(); _objectsService.RNDHome.bDataRead = true; }
...
//            if (_objectsService.RNDHome.drS["Chemist"] == DBNull.Value) gChemist = String.Empty; else gChemistSelectedValue = (int)_objectsService.RNDHome.drS["Chemist"];
//            if (_objectsService.RNDHome.drS["Operator"] == DBNull.Value) gOperator = String.Empty; else gOperatorSelectedValue = (int)_objectsService.RNDHome.drS["Operator"];
//            if (_objectsService.RNDHome.drS["Product ID"] == DBNull.Value) gProductID = String.Empty; else gProductIDSelectedValue = (string)_objectsService.RNDHome.drS["Product ID"];
//            if (_objectsService.RNDHome.drS["Study Type"] == DBNull.Value) gStudyType = String.Empty; else gStudyTypeSelectedValue = (int)_objectsService.RNDHome.drS["Study Type"];
...
//        private void OngFoamatGmLostFocus(object sender, RoutedEventArgs e)
//        {
...
//        private void gPO_LoadingRow(object sender, DataGridRowEventArgs e)
//        {
...
//        private void gPO_AddARow(object sender, RoutedEventArgs e)
//        {
...
//        private void gGenInfo_LF(object sender, RoutedEventArgs e)
//        {
...
//        private void gVisibility_LF(object sender, RoutedEventArgs e)
//        {

//        }

//        private void gPO_SelectionChanged(object sender, SelectionChangedEventArgs e)
//        {
...
//            if (_objectsService.RNDHome.drS["PORows"] != DBNull.Value) nRows = (int)_objectsService.RNDHome.drS["PORows"];
//            else nRows = 3;
