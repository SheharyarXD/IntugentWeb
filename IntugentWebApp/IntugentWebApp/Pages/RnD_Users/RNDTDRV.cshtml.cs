    ...
    public class RNDTDRVModel : PageModel
    {
       ...
       public DataView gExpPropsP {get;set;}
        ...
        public IActionResult OnPostGAgedTestingCompLF(bool value)
        {
            ...
            else if (gAgedTestingCompIsChecked == true) _objectsService.RNDHome.drS["AgedTestingComplete"] = true; else _objectsService.RNDHome.drS["AgedTestingComplete"] = false;
            _objectsService.RNDHome.UpdateDataSet();
            return null;
        }

        //public IActionResult OnPostOngExpPropsE(object sender, DataGridCellEditEndingEventArgs e)
        //{
        //    string sMsg;
        ...
        //    TextBox tb = gExpPropsE.Columns[icol].GetCellContent(dgr) as TextBox;
        ...
        //                   case 2:
        //                       if (!bd) { _objectsService.RNDHome.dtF.Rows[icol1]["K10D25FInit"] = DBNull.Value; _objectsService.RNDHome.dtF.Rows[icol1]["R10D25FInit"] = DBNull.Value; dtTdrvC.Rows[irow][icol1] = String.Empty; }
        //                       else if (dtemp > 0) { _objectsService.RNDHome.dtF.Rows[icol1]["K10D25FInit"] = dtemp; _objectsService.RNDHome.dtF.Rows[icol1]["R10D25FInit"] = 1 / dtemp; dtTdrvC.Rows[irow][icol1] = (1 / dtemp).ToString("0.###"); }
        //                       else { _objectsService.RNDHome.dtF.Rows[icol1]["K10D25FInit"] = dtemp; _objectsService.RNDHome.dtF.Rows[icol1]["R10D25FInit"] = DBNull.Value; dtTdrvC.Rows[irow][icol1] = string.Empty; }
        //                       break;

        //                   case 3:
        //                       if (!bd) { _objectsService.RNDHome.dtF.Rows[icol1]["K10D40FInit"] = DBNull.Value; _objectsService.RNDHome.dtF.Rows[icol1]["R10D40FInit"] = DBNull.Value; dtTdrvC.Rows[irow][icol1] = String.Empty; }
        //                       else if (dtemp > 0) { _objectsService.RNDHome.dtF.Rows[icol1]["K10D40FInit"] = dtemp; _objectsService.RNDHome.dtF.Rows[icol1]["R10D40FInit"] = 1 / dtemp; dtTdrvC.Rows[irow][icol1] = (1 / dtemp).ToString("0.###"); }
        //                       else { _objectsService.RNDHome.dtF.Rows[icol1]["K10D40FInit"] = dtemp; _objectsService.RNDHome.dtF.Rows[icol1]["R10D40FInit"] = DBNull.Value; dtTdrvC.Rows[irow][icol1] = string.Empty; }
        //                       break;

        //                   case 4:
        //                       if (!bd) { _objectsService.RNDHome.dtF.Rows[icol1]["K10D75FInit"] = DBNull.Value; _objectsService.RNDHome.dtF.Rows[icol1]["R10D75FInit"] = DBNull.Value; dtTdrvC.Rows[irow][icol1] = String.Empty; }
        //                       else if (dtemp > 0) { _objectsService.RNDHome.dtF.Rows[icol1]["K10D75FInit"] = dtemp; _objectsService.RNDHome.dtF.Rows[icol1]["R10D75FInit"] = 1 / dtemp; dtTdrvC.Rows[irow][icol1] = (1 / dtemp).ToString("0.###"); }
        //                       else { _objectsService.RNDHome.dtF.Rows[icol1]["K10D75FInit"] = dtemp; _objectsService.RNDHome.dtF.Rows[icol1]["R10D75FInit"] = DBNull.Value; dtTdrvC.Rows[irow][icol1] = string.Empty; }
        //                       break;

        //                   case 5:
        //                       if (!bd) { _objectsService.RNDHome.dtF.Rows[icol1]["K10D110FInit"] = DBNull.Value; _objectsService.RNDHome.dtF.Rows[icol1]["R10D110FInit"] = DBNull.Value; dtTdrvC.Rows[irow][icol1] = String.Empty; }
        //                       else if (dtemp > 0) { _objectsService.RNDHome.dtF.Rows[icol1]["K10D110FInit"] = dtemp; _objectsService.RNDHome.dtF.Rows[icol1]["R10D110FInit"] = 1 / dtemp; dtTdrvC.Rows[irow][icol1] = (1 / dtemp).ToString("0.###"); }
        //                       else { _objectsService.RNDHome.dtF.Rows[icol1]["K10D110FInit"] = dtemp; _objectsService.RNDHome.dtF.Rows[icol1]["R10D110FInit"] = DBNull.Value; dtTdrvC.Rows[irow][icol1] = string.Empty; }
        //                       break;

        //                   case 6: tb.Text = String.Empty; break;

        //                   case 7:
        //                       if (!bd) { _objectsService.RNDHome.dtF.Rows[icol1]["K10D25FFinal"] = DBNull.Value; _objectsService.RNDHome.dtF.Rows[icol1]["R10D25FFinal"] = DBNull.Value; dtTdrvC.Rows[irow][icol1] = String.Empty; }
        //                       else if (dtemp > 0) { _objectsService.RNDHome.dtF.Rows[icol1]["K10D25FFinal"] = dtemp; _objectsService.RNDHome.dtF.Rows[icol1]["R10D25FFinal"] = 1 / dtemp; dtTdrvC.Rows[irow][icol1] = (1 / dtemp).ToString("0.###"); }
        //                       else { _objectsService.RNDHome.dtF.Rows[icol1]["K10D25FFinal"] = dtemp; _objectsService.RNDHome.dtF.Rows[icol1]["R10D25FFinal"] = DBNull.Value; dtTdrvC.Rows[irow][icol1] = string.Empty; }
        //                       break;

        //                   case 8:
        //                       if (!bd) { _objectsService.RNDHome.dtF.Rows[icol1]["K10D40FFinal"] = DBNull.Value; _objectsService.RNDHome.dtF.Rows[icol1]["R10D40FFinal"] = DBNull.Value; dtTdrvC.Rows[irow][icol1] = String.Empty; }
        //                       else if (dtemp > 0) { _objectsService.RNDHome.dtF.Rows[icol1]["K10D40FFinal"] = dtemp; _objectsService.RNDHome.dtF.Rows[icol1]["R10D40FFinal"] = 1 / dtemp; dtTdrvC.Rows[irow][icol1] = (1 / dtemp).ToString("0.###"); }
        //                       else { _objectsService.RNDHome.dtF.Rows[icol1]["K10D40FFinal"] = dtemp; _objectsService.RNDHome.dtF.Rows[icol1]["R10D40FFinal"] = DBNull.Value; dtTdrvC.Rows[irow][icol1] = string.Empty; }
        //                       break;

        //                   case 9:
        //                       if (!bd) { _objectsService.RNDHome.dtF.Rows[icol1]["K10D75FFinal"] = DBNull.Value; _objectsService.RNDHome.dtF.Rows[icol1]["R10D75FFinal"] = DBNull.Value; dtTdrvC.Rows[irow][icol1] = String.Empty; }
        //                       else if (dtemp > 0) { _objectsService.RNDHome.dtF.Rows[icol1]["K10D75FFinal"] = dtemp; _objectsService.RNDHome.dtF.Rows[icol1]["R10D75FFinal"] = 1 / dtemp; dtTdrvC.Rows[irow][icol1] = (1 / dtemp).ToString("0.###"); }
        //                       else { _objectsService.RNDHome.dtF.Rows[icol1]["K10D75FFinal"] = dtemp; _objectsService.RNDHome.dtF.Rows[icol1]["R10D75FFinal"] = DBNull.Value; dtTdrvC.Rows[irow][icol1] = string.Empty; }
        //                       break;

        //                   case 10:
        //                       if (!bd) { _objectsService.RNDHome.dtF.Rows[icol1]["K10D110FFinal"] = DBNull.Value; _objectsService.RNDHome.dtF.Rows[icol1]["R10D110FFinal"] = DBNull.Value; dtTdrvC.Rows[irow][icol1] = String.Empty; }
        //                       else if (dtemp > 0) { _objectsService.RNDHome.dtF.Rows[icol1]["K10D110FFinal"] = dtemp; _objectsService.RNDHome.dtF.Rows[icol1]["R10D110FFinal"] = 1 / dtemp; dtTdrvC.Rows[irow][icol1] = (1 / dtemp).ToString("0.###"); }
        //                       else { _objectsService.RNDHome.dtF.Rows[icol1]["K10D110FFinal"] = dtemp; _objectsService.RNDHome.dtF.Rows[icol1]["R10D110FFinal"] = DBNull.Value; dtTdrvC.Rows[irow][icol1] = string.Empty; }
        //                       break;
        ...
        //                   case 14:
        //                       if (!bd) { _objectsService.RNDHome.dtF.Rows[icol1]["K90D25FInit"] = DBNull.Value; _objectsService.RNDHome.dtF.Rows[icol1]["R90D25FInit"] = DBNull.Value; dtTdrvC.Rows[irow][icol1] = String.Empty; }
        //                       else if (dtemp > 0) { _objectsService.RNDHome.dtF.Rows[icol1]["K90D25FInit"] = dtemp; _objectsService.RNDHome.dtF.Rows[icol1]["R90D25FInit"] = 1 / dtemp; dtTdrvC.Rows[irow][icol1] = (1 / dtemp).ToString("0.###"); }
        //                       else { _objectsService.RNDHome.dtF.Rows[icol1]["K90D25FInit"] = dtemp; _objectsService.RNDHome.dtF.Rows[icol1]["R90D25FInit"] = DBNull.Value; dtTdrvC.Rows[irow][icol1] = string.Empty; }
        //                       break;

        //                   case 15:
        //                       if (!bd) { _objectsService.RNDHome.dtF.Rows[icol1]["K90D40FInit"] = DBNull.Value; _objectsService.RNDHome.dtF.Rows[icol1]["R90D40FInit"] = DBNull.Value; dtTdrvC.Rows[irow][icol1] = String.Empty; }
        //                       else if (dtemp > 0) { _objectsService.RNDHome.dtF.Rows[icol1]["K90D40FInit"] = dtemp; _objectsService.RNDHome.dtF.Rows[icol1]["R90D40FInit"] = 1 / dtemp; dtTdrvC.Rows[irow][icol1] = (1 / dtemp).ToString("0.###"); }
        //                       else { _objectsService.RNDHome.dtF.Rows[icol1]["K90D40FInit"] = dtemp; _objectsService.RNDHome.dtF.Rows[icol1]["R90D40FInit"] = DBNull.Value; dtTdrvC.Rows[irow][icol1] = string.Empty; }
        //                       break;

        //                   case 16:
        //                       if (!bd) { _objectsService.RNDHome.dtF.Rows[icol1]["K90D75FInit"] = DBNull.Value; _objectsService.RNDHome.dtF.Rows[icol1]["R90D75FInit"] = DBNull.Value; dtTdrvC.Rows[irow][icol1] = String.Empty; }
        //                       else if (dtemp > 0) { _objectsService.RNDHome.dtF.Rows[icol1]["K90D75FInit"] = dtemp; _objectsService.RNDHome.dtF.Rows[icol1]["R90D75FInit"] = 1 / dtemp; dtTdrvC.Rows[irow][icol1] = (1 / dtemp).ToString("0.###"); }
        //                       else { _objectsService.RNDHome.dtF.Rows[icol1]["K90D75FInit"] = dtemp; _objectsService.RNDHome.dtF.Rows[icol1]["R90D75FInit"] = DBNull.Value; dtTdrvC.Rows[irow][icol1] = string.Empty; }
        //                       break;

        //                   case 17:
        //                       if (!bd) { _objectsService.RNDHome.dtF.Rows[icol1]["K90D110FInit"] = DBNull.Value; _objectsService.RNDHome.dtF.Rows[icol1]["R90D110FInit"] = DBNull.Value; dtTdrvC.Rows[irow][icol1] = String.Empty; }
        //                       else if (dtemp > 0) { _objectsService.RNDHome.dtF.Rows[icol1]["K90D110FInit"] = dtemp; _objectsService.RNDHome.dtF.Rows[icol1]["R90D110FInit"] = 1 / dtemp; dtTdrvC.Rows[irow][icol1] = (1 / dtemp).ToString("0.###"); }
        //                       else { _objectsService.RNDHome.dtF.Rows[icol1]["K90D110FInit"] = dtemp; _objectsService.RNDHome.dtF.Rows[icol1]["R90D110FInit"] = DBNull.Value; dtTdrvC.Rows[irow][icol1] = string.Empty; }
        //                       break;

        //                   case 18: tb.Text = String.Empty; break;

        //                   case 19:
        //                       if (!bd) { _objectsService.RNDHome.dtF.Rows[icol1]["K90D25FFinal"] = DBNull.Value; _objectsService.RNDHome.dtF.Rows[icol1]["R90D25FFinal"] = DBNull.Value; dtTdrvC.Rows[irow][icol1] = String.Empty; }
        //                       else if (dtemp > 0) { _objectsService.RNDHome.dtF.Rows[icol1]["K90D25FFinal"] = dtemp; _objectsService.RNDHome.dtF.Rows[icol1]["R90D25FFinal"] = 1 / dtemp; dtTdrvC.Rows[irow][icol1] = (1 / dtemp).ToString("0.###"); }
        //                       else { _objectsService.RNDHome.dtF.Rows[icol1]["K90D25FFinal"] = dtemp; _objectsService.RNDHome.dtF.Rows[icol1]["R90D25FFinal"] = DBNull.Value; dtTdrvC.Rows[irow][icol1] = string.Empty; }
        //                       break;

        //                   case 20:
        //                       if (!bd) { _objectsService.RNDHome.dtF.Rows[icol1]["K90D40FFinal"] = DBNull.Value; _objectsService.RNDHome.dtF.Rows[icol1]["R90D40FFinal"] = DBNull.Value; dtTdrvC.Rows[irow][icol1] = String.Empty; }
        //                       else if (dtemp > 0) { _objectsService.RNDHome.dtF.Rows[icol1]["K90D40FFinal"] = dtemp; _objectsService.RNDHome.dtF.Rows[icol1]["R90D40FFinal"] = 1 / dtemp; dtTdrvC.Rows[irow][icol1] = (1 / dtemp).ToString("0.###"); }
        //                       else { _objectsService.RNDHome.dtF.Rows[icol1]["K90D40FFinal"] = dtemp; _objectsService.RNDHome.dtF.Rows[icol1]["R90D40FFinal"] = DBNull.Value; dtTdrvC.Rows[irow][icol1] = string.Empty; }
        //                       break;

        //                   case 21:
        //                       if (!bd) { _objectsService.RNDHome.dtF.Rows[icol1]["K90D75FFinal"] = DBNull.Value; _objectsService.RNDHome.dtF.Rows[icol1]["R90D75FFinal"] = DBNull.Value; dtTdrvC.Rows[irow][icol1] = String.Empty; }
        //                       else if (dtemp > 0) { _objectsService.RNDHome.dtF.Rows[icol1]["K90D75FFinal"] = dtemp; _objectsService.RNDHome.dtF.Rows[icol1]["R90D75FFinal"] = 1 / dtemp; dtTdrvC.Rows[irow][icol1] = (1 / dtemp).ToString("0.###"); }
        //                       else { _objectsService.RNDHome.dtF.Rows[icol1]["K90D75FFinal"] = dtemp; _objectsService.RNDHome.dtF.Rows[icol1]["R90D75FFinal"] = DBNull.Value; dtTdrvC.Rows[irow][icol1] = string.Empty; }
        //                       break;

        //                   case 22:
        //                       if (!bd) { _objectsService.RNDHome.dtF.Rows[icol1]["K90D110FFinal"] = DBNull.Value; _objectsService.RNDHome.dtF.Rows[icol1]["R90D110FFinal"] = DBNull.Value; dtTdrvC.Rows[irow][icol1] = String.Empty; }
        //                       else if (dtemp > 0) { _objectsService.RNDHome.dtF.Rows[icol1]["K90D110FFinal"] = dtemp; _objectsService.RNDHome.dtF.Rows[icol1]["R90D110FFinal"] = 1 / dtemp; dtTdrvC.Rows[irow][icol1] = (1 / dtemp).ToString("0.###"); }
        //                       else { _objectsService.RNDHome.dtF.Rows[icol1]["K90D110FFinal"] = dtemp; _objectsService.RNDHome.dtF.Rows[icol1]["R90D110FFinal"] = DBNull.Value; dtTdrvC.Rows[irow][icol1] = string.Empty; }
        //                       break;
        ...
        //                   case 26:
        //                       if (!bd) { _objectsService.RNDHome.dtF.Rows[icol1]["K180D25FInit"] = DBNull.Value; _objectsService.RNDHome.dtF.Rows[icol1]["R180D25FInit"] = DBNull.Value; dtTdrvC.Rows[irow][icol1] = String.Empty; }
        //                       else if (dtemp > 0) { _objectsService.RNDHome.dtF.Rows[icol1]["K180D25FInit"] = dtemp; _objectsService.RNDHome.dtF.Rows[icol1]["R180D25FInit"] = 1 / dtemp; dtTdrvC.Rows[irow][icol1] = (1 / dtemp).ToString("0.###"); }
        //                       else { _objectsService.RNDHome.dtF.Rows[icol1]["K180D25FInit"] = dtemp; _objectsService.RNDHome.dtF.Rows[icol1]["R180D25FInit"] = DBNull.Value; dtTdrvC.Rows[irow][icol1] = string.Empty; }
        //                       break;

        //                   case 27:
        //                       if (!bd) { _objectsService.RNDHome.dtF.Rows[icol1]["K180D40FInit"] = DBNull.Value; _objectsService.RNDHome.dtF.Rows[icol1]["R180D40FInit"] = DBNull.Value; dtTdrvC.Rows[irow][icol1] = String.Empty; }
        //                       else if (dtemp > 0) { _objectsService.RNDHome.dtF.Rows[icol1]["K180D40FInit"] = dtemp; _objectsService.RNDHome.dtF.Rows[icol1]["R180D40FInit"] = 1 / dtemp; dtTdrvC.Rows[irow][icol1] = (1 / dtemp).ToString("0.###"); }
        //                       else { _objectsService.RNDHome.dtF.Rows[icol1]["K180D40FInit"] = dtemp; _objectsService.RNDHome.dtF.Rows[icol1]["R180D40FInit"] = DBNull.Value; dtTdrvC.Rows[irow][icol1] = string.Empty; }
        //                       break;

        //                   case 28:
        //                       if (!bd) { _objectsService.RNDHome.dtF.Rows[icol1]["K180D75FInit"] = DBNull.Value; _objectsService.RNDHome.dtF.Rows[icol1]["R180D75FInit"] = DBNull.Value; dtTdrvC.Rows[irow][icol1] = String.Empty; }
        //                       else if (dtemp > 0) { _objectsService.RNDHome.dtF.Rows[icol1]["K180D75FInit"] = dtemp; _objectsService.RNDHome.dtF.Rows[icol1]["R180D75FInit"] = 1 / dtemp; dtTdrvC.Rows[irow][icol1] = (1 / dtemp).ToString("0.###"); }
        //                       else { _objectsService.RNDHome.dtF.Rows[icol1]["K180D75FInit"] = dtemp; _objectsService.RNDHome.dtF.Rows[icol1]["R180D75FInit"] = DBNull.Value; dtTdrvC.Rows[irow][icol1] = string.Empty; }
        //                       break;

        //                   case 29:
        //                       if (!bd) { _objectsService.RNDHome.dtF.Rows[icol1]["K180D110FInit"] = DBNull.Value; _objectsService.RNDHome.dtF.Rows[icol1]["R180D110FInit"] = DBNull.Value; dtTdrvC.Rows[irow][icol1] = String.Empty; }
        //                       else if (dtemp > 0) { _objectsService.RNDHome.dtF.Rows[icol1]["K180D110FInit"] = dtemp; _objectsService.RNDHome.dtF.Rows[icol1]["R180D110FInit"] = 1 / dtemp; dtTdrvC.Rows[irow][icol1] = (1 / dtemp).ToString("0.###"); }
        //                       else { _objectsService.RNDHome.dtF.Rows[icol1]["K180D110FInit"] = dtemp; _objectsService.RNDHome.dtF.Rows[icol1]["R180D110FInit"] = DBNull.Value; dtTdrvC.Rows[irow][icol1] = string.Empty; }
        //                       break;

        //                   case 30: tb.Text = String.Empty; break;

        //                   case 31:
        //                       if (!bd) { _objectsService.RNDHome.dtF.Rows[icol1]["K180D25FFinal"] = DBNull.Value; _objectsService.RNDHome.dtF.Rows[icol1]["R180D25FFinal"] = DBNull.Value; dtTdrvC.Rows[irow][icol1] = String.Empty; }
        //                       else if (dtemp > 0) { _objectsService.RNDHome.dtF.Rows[icol1]["K180D25FFinal"] = dtemp; _objectsService.RNDHome.dtF.Rows[icol1]["R180D25FFinal"] = 1 / dtemp; dtTdrvC.Rows[irow][icol1] = (1 / dtemp).ToString("0.###"); }
        //                       else { _objectsService.RNDHome.dtF.Rows[icol1]["K180D25FFinal"] = dtemp; _objectsService.RNDHome.dtF.Rows[icol1]["R180D25FFinal"] = DBNull.Value; dtTdrvC.Rows[irow][icol1] = string.Empty; }
        //                       break;

        //                   case 32:
        //                       if (!bd) { _objectsService.RNDHome.dtF.Rows[icol1]["K180D40FFinal"] = DBNull.Value; _objectsService.RNDHome.dtF.Rows[icol1]["R180D40FFinal"] = DBNull.Value; dtTdrvC.Rows[irow][icol1] = String.Empty; }
        //                       else if (dtemp > 0) { _objectsService.RNDHome.dtF.Rows[icol1]["K180D40FFinal"] = dtemp; _objectsService.RNDHome.dtF.Rows[icol1]["R180D40FFinal"] = 1 / dtemp; dtTdrvC.Rows[irow][icol1] = (1 / dtemp).ToString("0.###"); }
        //                       else { _objectsService.RNDHome.dtF.Rows[icol1]["K180D40FFinal"] = dtemp; _objectsService.RNDHome.dtF.Rows[icol1]["R180D40FFinal"] = DBNull.Value; dtTdrvC.Rows[irow][icol1] = string.Empty; }
        //                       break;

        //                   case 33:
        //                       if (!bd) { _objectsService.RNDHome.dtF.Rows[icol1]["K180D75FFinal"] = DBNull.Value; _objectsService.RNDHome.dtF.Rows[icol1]["R180D75FFinal"] = DBNull.Value; dtTdrvC.Rows[irow][icol1] = String.Empty; }
        //                       else if (dtemp > 0) { _objectsService.RNDHome.dtF.Rows[icol1]["K180D75FFinal"] = dtemp; _objectsService.RNDHome.dtF.Rows[icol1]["R180D75FFinal"] = 1 / dtemp; dtTdrvC.Rows[irow][icol1] = (1 / dtemp).ToString("0.###"); }
        //                       else { _objectsService.RNDHome.dtF.Rows[icol1]["K180D75FFinal"] = dtemp; _objectsService.RNDHome.dtF.Rows[icol1]["R180D75FFinal"] = DBNull.Value; dtTdrvC.Rows[irow][icol1] = string.Empty; }
        //                       break;

        //                   case 34:
        //                       if (!bd) { _objectsService.RNDHome.dtF.Rows[icol1]["K180D110FFinal"] = DBNull.Value; _objectsService.RNDHome.dtF.Rows[icol1]["R180D110FFinal"] = DBNull.Value; dtTdrvC.Rows[irow][icol1] = String.Empty; }
        //                       else if (dtemp > 0) { _objectsService.RNDHome.dtF.Rows[icol1]["K180D110FFinal"] = dtemp; _objectsService.RNDHome.dtF.Rows[icol1]["R180D110FFinal"] = 1 / dtemp; dtTdrvC.Rows[irow][icol1] = (1 / dtemp).ToString("0.###"); }
        //                       else { _objectsService.RNDHome.dtF.Rows[icol1]["K180D110FFinal"] = dtemp; _objectsService.RNDHome.dtF.Rows[icol1]["R180D110FFinal"] = DBNull.Value; dtTdrvC.Rows[irow][icol1] = string.Empty; }
        //                       break;
        ...
        //    else { tb.Text = string.Empty; return null; }
        ...
        //public bool GetTDRVValues(string[] sFields, int irow, int icol1, TextBox tb, string[] sFieldsR)
        //{
        //    string stmp, stmp0;
        //    double dtmp;
        //    bool b = false;
        ...
        //    if (tb.Text == string.Empty) { _objectsService.RNDHome.dtF.Rows[icol1][sFieldR] = _objectsService.RNDHome.dtF.Rows[icol1][sField] = DBNull.Value; _objectsService.RNDTDRV.dtTdrvC.Rows[irow][icol1] = string.Empty; b = true; }
        //    else if (double.TryParse(tb.Text, out dtmp))
        //    {
        //        if (dtmp > 0)
        //        {
